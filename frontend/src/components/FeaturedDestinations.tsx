...
const FeaturedDestinations: React.FC<FeaturedDestinationsProps> = ({ onSelect, selectedId }) => {
                            ...
                            <div className="aspect-[16/9] overflow-hidden">
                                <img
                                    ...
                                    onError={(e) => {
                                        ...
                                        target.src = "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?q=80&w=2070&auto=format&fit=crop"; // Fallback travel image
                                    }}
