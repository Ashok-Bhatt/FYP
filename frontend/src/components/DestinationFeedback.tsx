...
interface DestinationFeedbackProps {
    selectedDestination: Destination | null;
}

const DestinationFeedback: React.FC<DestinationFeedbackProps> = ({ selectedDestination }) => {
    const containerRef = useRef<HTMLDivElement>(null);
    const contentRef = useRef<HTMLDivElement>(null);

    useEffect(() => {
        if (selectedDestination && contentRef.current) {
