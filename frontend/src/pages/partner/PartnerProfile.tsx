...
import { FaSave, FaSpinner, FaCheckCircle, FaHotel, FaPhone, FaEnvelope, FaGlobe, FaFacebook, FaInstagram, FaTwitter, FaLinkedin, FaMapMarkerAlt, FaStar, FaMoneyBillWave, FaClock } from 'react-icons/fa';
...
const PartnerProfile: React.FC = () => {
    ...
    const fetchProfile = async () => {
        try {
            ...
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/partners/profile`, config);
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto">
                        Manage your hotel information and services
                    </p>
                </div>
